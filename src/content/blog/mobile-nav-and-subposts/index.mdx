...
Then, when the user scrolls down past a certain threshold (100 pixels in this case), the header becomes visible by removing the `-translate-y-full` class, which is responsible for hiding it off-screen. 
